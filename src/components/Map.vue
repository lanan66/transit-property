...
<script setup>
// 引入工具
import geoJson from "../assets/static/map-data/guangzhou.json"; //该文件路径改成自己项目中的文件路径即可
...
const chartMap = () => {
  ...
  // 重点：不要遗漏这句代码！！
  echarts.registerMap("guangghou", geoJson);
  // 图表配置项
  let option = {
    //3D地图配置项
    geo3D: {
