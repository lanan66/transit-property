          ...
          <div class="content" v-show="current == 0">
            ...
            <div class="operational-metrics">
              ...
              <div class="operational-metrics-con">
                <!-- 指标项 -->
                <div class="operational-metrics-items" v-for="(item, index) in metrics" :key="item.id">
                  <div class="operational-metrics-items-title">{{ item.name }}</div>
                  <div class="operational-metrics-items-value">{{ item.value }}</div>
                </div>
              </div>
            </div>
          </div>
